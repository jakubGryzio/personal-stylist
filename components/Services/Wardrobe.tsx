          ...
          <Col className={`${classes.description}`}>
            ...
            <ul>
              <li>
                ...
                надихають та які ви не носите, Ця послуга для вас, якщо покупки
                нових речей, ніяк не змінюють ваш гардероб, ви прагнете стильно
                одягатися та мати гардероб, який використовуватимете на 100
                відсотків.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                ...
                товарний вигляд, речі, які не підходять вашому способу життя та
                вподобанням.
              </li>
              <li>
                Шопінг-лист з речами, які я рекомендую оновити чи докупити, які
                доповнять ваш гардероб, зроблять його свіжим та актуальним. До
                кожного виробу буде декілька альтернативних варіантів з
                посиланнями.
              </li>
              <li>
                Сформовані образи, які будуть підходити вам по характеру,
                звичкам, вподобанням та будуть гармонійні з вами. Це допоможе
                зекономити час на думки ‘що одягнути’, бо ви будете мати одразу
                актуальні та цікаві комбінації.
              </li>
            </ul>
            <h2>ЩО ВИ ОТРИМАЄТЕ ?</h2>
            <ul>
              ...
              <li>
                Ми працюємо над конкретним сезоном (осінь-зима або весна-літо).
              </li>
              ...
              <li>
                ...
                залишається з вами, де буде розписана вся інформація щодо вибору
                речей, сформовані образи та шопінг-лист.
              </li>
              <li>
                Час роботи офлайн - 3 години, якщо у вас великий гардероб, кожна
                наступна година оплачується додатково : 1 година - 10 $
              </li>
            </ul>
            <h2>ВАРТІСТЬ</h2>
            <ul>
